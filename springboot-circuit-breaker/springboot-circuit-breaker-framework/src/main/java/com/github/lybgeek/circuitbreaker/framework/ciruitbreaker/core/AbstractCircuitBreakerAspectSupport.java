...
public abstract class AbstractCircuitBreakerAspectSupport {
    ...
    protected void traceException(Throwable ex, CircuitBreakerMapping annotation) {
    ...
    protected Object handleFallback(ProceedingJoinPoint pjp, CircuitBreakerMapping annotation, Throwable ex)
            throws Throwable {
    ...
    protected Object handleDefaultFallback(ProceedingJoinPoint pjp, String defaultFallback,
        ...
        BlockExceptionHandler handler = SpringUtil.getBean(BlockExceptionHandler.class);
        if(ex instanceof BlockException && !ObjectUtils.isEmpty(handler)){
            BlockException blockException = (BlockException) ex;
            handler.handle(getRequest(),getResponse(),blockException);
        }
    ...
    protected Object handleBlockException(ProceedingJoinPoint pjp, CircuitBreakerMapping annotation, BlockException ex)
            throws Throwable {
