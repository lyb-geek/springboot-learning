...
public final class ReflectionUtils {
    ...
    public static Object getFieldValue(Object entity, String fieldName) {
        ...
        try {
            ...
            throw ExceptionUtils.cause("Error: Cannot read field in %s.  Cause:", e, cls.getSimpleName());
        }
    }
    ...
    public static Object getMethodValue(Class<?> cls, Object entity, String str) {
        ...
        try {
            ...
            throw ExceptionUtils.cause("Error: NoSuchMethod in %s.  Cause:", e, cls.getSimpleName());
        } catch (IllegalAccessException e) {
            throw ExceptionUtils.cause("Error: Cannot execute a private method. in %s.  Cause:", e, cls.getSimpleName());
        } catch (InvocationTargetException e) {
            throw ExceptionUtils.cause("Error: InvocationTargetException on getMethodValue.  Cause:" + e);
        }
    }
    ...
    public static Map<String, Field> getFieldMap(Class<?> clazz) {
        ...
        return CollectionUtils.isEmpty(fieldList) ? Collections.emptyMap() : fieldList.stream().collect(toMap(Field::getName, field -> field)) ;
    }
