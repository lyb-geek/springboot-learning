...
package com.github.lybgeek.test.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo groupApiInfo(){
        return new ApiInfoBuilder()
                .title("lybgeek-microservices")
                .description("<div style='font-size:14px;color:red;'>LYBGEEK MiCROSERVICES RESTful APIs</div>")
                .termsOfServiceUrl("http://www.lybgeek.com/")
                .version("1.0")
                .build();
    }
