...
package com.github.lybgeek.loadbalance.exception;
...
public class LoadbalanceException extends RuntimeException {
    ...
    public LoadbalanceException(final int errCode, final String errMsg) {
        super(errMsg);
        this.errCode = errCode;
        this.errMsg = errMsg;
    }
    
    public LoadbalanceException(final int errCode, final Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
        this.setCauseThrowable(throwable);
    }
    
    public LoadbalanceException(final int errCode, final String errMsg, final Throwable throwable) {
    ...
    public String getErrMsg() {
        if (!StrUtil.isBlank(this.errMsg)) {
            return this.errMsg;
        }
